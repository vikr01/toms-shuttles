                ...
                switch (_b.label) {
                    ...
                    case 6:
                        ...
                        if (newColumn.type === "enum" && oldColumn.type === "enum" && !OrmUtils.isArraysEqual(newColumn.enum, oldColumn.enum)) {
                            ...
                            upType = "" + enumNameWithoutSchema + arraySuffix + " USING \"" + newColumn.name + "\"::\"text\"::" + enumNameWithoutSchema + arraySuffix;
                            downType = "" + oldEnumNameWithoutSchema + arraySuffix + " USING \"" + newColumn.name + "\"::\"text\"::" + oldEnumNameWithoutSchema + arraySuffix;
